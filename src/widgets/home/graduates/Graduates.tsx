        ...
        <ul className="graduates__cards-list">
          ...
          <li className="graduates__cards-item">
            <GraduatesCard
              ...
              description={
                "Благодаря Университетскому колледжу СГУ я смог получить необходимые навыки, сформировать правильное отношение к профессии, понять ее философию и ценности. Именно здесь я осознал, что кулинария – искусство, наука и постоянное самосовершенствование"
              }
